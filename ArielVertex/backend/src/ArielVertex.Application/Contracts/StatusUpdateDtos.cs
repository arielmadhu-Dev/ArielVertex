...
public record StatusUpdateDto(
    ...
    string Dependencies, decimal BillableHours, decimal NonBillableHours, decimal HoursSpent, UpdateStatus Status,
...
public record CreateStatusUpdateRequest(
    ...
    [Range(0, 24)] decimal BillableHours,
    [Range(0, 24)] decimal NonBillableHours,
